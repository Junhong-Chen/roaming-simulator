...
void main() {
  ...
  // vec3 albedo = mix((diffuseLight * 0.3 + scatter) * getShadowMask(), (vec3(0.1) + reflectionSample * 0.9 + reflectionSample * specularLight), reflectance);

  gl_FragColor = vec4(reflectionSample, alpha);
}